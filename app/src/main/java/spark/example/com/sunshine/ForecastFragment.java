package spark.example.com.sunshine;
...
public class ForecastFragment extends Fragment {
    ...
    // override onCreateView, which happens afterwards
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayAdapter<String> mForecastAdapter = new ArrayAdapter<String>(getActivity(),
                ...
                R.id.list_item_forecast_textview, // textview to populate
                weekForecast); // data
    ...
    // pass in String
    // output String array of forecasts
    public class FetchWeatherTask extends AsyncTask<String,Void,String[]> {

        // This ensures that "FetchWeatherTask" name in sync- throw an error if changed
        ...
        protected String[] doInBackground(String... params) {
            ...
            // If there's no zip code, nothing to look up
            if (params.length == 0)
            {
                return null;
            }
